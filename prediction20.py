...
qualifying_2025 = pd.DataFrame({
    "Driver": ["Lando Norris", "Charles Leclerc", "Lewis Hamilton", "George Russell",
               "Max Verstappen", "Kimi Antonelli", "Carlos Sainz", "Oscar Piastri",
               "Isack Hadjar", "Oliver Bearman"],
    "QualifyingTime (s)": [75.586, 75.848, 75.938, 76.034,
                           76.070, 76.118, 76.172, 76.174, 76.252, 76.460]
})
