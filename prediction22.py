...
qualifying_2025 = pd.DataFrame({  
    "Driver": ["Lando Norris", "Max Verstappen", "Carlos Sainz", "George Russell",  
               "Oscar Piastri", "Liam Lawson", "Fernando Alonso", "Isack Hadjar",  
               "Charles Leclerc", "Pierre Gasly"],  
    "QualifyingTime (s)": [107.934, 108.257, 108.296, 108.803,  
                           108.961, 109.062, 109.466, 109.554,  
                           109.872, 111.540]  
})  
