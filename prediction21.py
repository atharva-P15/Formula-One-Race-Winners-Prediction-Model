...
qualifying_2025 = pd.DataFrame({
    "Driver": ["Lando Norris", "Kimi Antonelli", "Charles Leclerc", "Oscar Piastri",
               "Isack Hadjar", "George Russell", "Liam Lawson", "Oliver Bearman",
               "Pierre Gasly", "Nico Hulkenberg"],
    "QualifyingTime (s)": [69.511, 69.685, 69.805, 69.886,
                           69.931, 69.942, 69.962, 69.977,
                           70.002, 70.039]
})
...
driver_mapping = {
    ...
    "Isack Hadjar": "HAD", "Gabriel Bortoleto": "BOR", "Kimi Antonelli": "ANT",
    "Liam Lawson": "LAW"  # Added Liam Lawson for completeness as he was in Q3
}
